...
import sys
import time
from pythonLevel3.pygame.catRunFast_master.mylibrary import MySprite
            ...
            if game_pause :
                ...
                if you_win:
                    ...
                    while current_time<5:
                        ...
                        print(font1, 270, 150,"YOU WIN THE GAME!",(240,20,20))
                        current_time =time.clock()-start_time
                        print(font1, 320, 250, "Best Score:",(120,224,22))
                        print(font1, 370, 290, str(best_score),(255,0,0))
                        print(font1, 270, 330, "This Game Score:",(120,224,22))
                        print(font1, 385, 380, str(score),(255,0,0))
                ...
                while current_time<3:
                    screen.fill((200, 200, 200))
                    print(font1, 320, 250,game_round[index],(240,20,20))
                    pygame.display.update()
                    game_pause = False
                    current_time =time.clock()-start_time
                ...
                print(font, 330, 560, "press SPACE to jump up!")
                print(font, 200, 20, "You have get Score:",(219,224,22))
                print(font1, 380, 10, str(score),(255,0,0))
                if game_over:
                    start_time = time.clock()
                    current_time =time.clock()-start_time
                    while current_time<5:
                        screen.fill((200, 200, 200))
                        print(font1, 300, 150,"GAME OVER!",(240,20,20))
                        current_time =time.clock()-start_time
                        print(font1, 320, 250, "Best Score:",(120,224,22))
                        if score >int (best_score):
                            best_score = score
                        print(font1, 370, 290, str(best_score),(255,0,0))
                        print(font1, 270, 330, "This Game Score:",(120,224,22))
                        print(font1, 370, 380, str(score),(255,0,0))
                        pygame.display.update()
                    fd_2 = open("data.txt","w+")
                    fd_2.write(str(best_score))
                    fd_2.close()
