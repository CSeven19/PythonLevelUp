...
def run():
    ...
    button_width = 150
    buttons = {}
    buttons["prev"] = Button("flame.png", (x, y))
    buttons["pause"] = Button("flame.png", (x + button_width * 1, y))
    buttons["stop"] = Button("flame.png", (x + button_width * 2, y))
    buttons["play"] = Button("flame.png", (x + button_width * 3, y))
    buttons["next"] = Button("flame.png", (x + button_width * 4, y))

    music_filenames = get_music(MUSIC_PATH)
    if len(music_filenames) == 0:
        print
        "No music files found in ", MUSIC_PATH
        return
